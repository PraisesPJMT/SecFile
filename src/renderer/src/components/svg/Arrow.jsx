/**
 * Renders an SVG arrow component.
 *
 * @return {JSX.Element} The SVG arrow component.
 */
const Arrow = () => {
  return (
    <svg
      ...
      width="800px"
      height="800px"
      viewBox="0 0 414.287 414.287"
      xmlSpace="preserve"
    >
      <g>
        <path
          d="M412.398,202.993L288.535,95.289c-1.502-1.305-3.591-1.699-5.463-1.027c-1.873,0.67-3.237,2.3-3.568,4.261l-8.938,52.887
